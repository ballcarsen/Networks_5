...
if __name__ == '__main__':
    ...
    #Label frame based on the dst, Assigns -1 to ip packets
    encap_tbl_D = {'H2' : '11'}  # table used to encapsulate network packets into MPLS frames
    frwd_tbl_D = {'11': {0:('22',1)}}  # table used to forward MPLS frames, {in_label{in_intf:(outlabel, out_inft}}
